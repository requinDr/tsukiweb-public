...
export const GALLERY_IMAGES: Record<string, GalleryImg> = {
  ...
  "ark_e04b": {img: "ark_e04b", path: "event", route: "ark"},
  ...
  "ark_e06b": {img: "ark_e06b", path: "event", route: "ark"},
  "ark_e07": {img: "ark_e07", path: "event", route: "ark"},
  "ark_f01": {img: "ark_f01", path: "event", route: "ark"},
  "ark_f02": {img: "ark_f02", path: "event", route: "ark"},
  ...
  "cel_e02b": { img: "cel_e02b", path: "event", route: "cel" },
  "cel_e03a": { img: "cel_e03a", path: "event", route: "cel" },
  "cel_e03b": { img: "cel_e03b", path: "event", route: "cel" },
  "cel_e04": { img: "cel_e04", path: "event", route: "cel" },
  "cel_e05a": { img: "cel_e05a", path: "event", route: "cel" },
  "cel_e05b": { img: "cel_e05b", path: "event", route: "cel" },
  "cel_e09": { img: "cel_e09", path: "event", route: "cel" },
  "cel_e06a": { img: "cel_e06a", path: "event", route: "cel" },
  "cel_e06b": { img: "cel_e06b", path: "event", route: "cel" },
  "cel_e07a": { img: "cel_e07a", path: "event", route: "cel" },
  "cel_e07b": { img: "cel_e07b", path: "event", route: "cel" },
  "cel_e07c": { img: "cel_e07c", path: "event", route: "cel" },
  "cel_e08": { img: "cel_e08", path: "event", route: "cel" },
  "cel_f01": { img: "cel_f01", path: "event", route: "cel" },
  "cel_f01b": { img: "cel_f01b", path: "event", route: "cel" },
  "cel_f02": { img: "cel_f02", path: "event", route: "cel" },
  ...
  "cel_h03b": { img: "cel_h03b", path: "event", route: "cel", sensitive: true },
  "cel_h04a": { img: "cel_h04a", path: "event", route: "cel", sensitive: true },
  "cel_h04b": { img: "cel_h04b", path: "event", route: "cel", sensitive: true },
  "cel_h05a": { img: "cel_h05a", path: "event", route: "cel", sensitive: true },
  "cel_h05b": { img: "cel_h05b", path: "event", route: "cel", sensitive: true },
  "cel_h06a": { img: "cel_h06a", path: "event", route: "cel", sensitive: true },
  "cel_h06b": { img: "cel_h06b", path: "event", route: "cel", sensitive: true },
  "cel_h07a": { img: "cel_h07a", path: "event", route: "cel", sensitive: true },
  "cel_h07b": { img: "cel_h07b", path: "event", route: "cel", sensitive: true },
  "cel_h08a": { img: "cel_h08a", path: "event", route: "cel", sensitive: true },
  "cel_h08b": { img: "cel_h08b", path: "event", route: "cel", sensitive: true },
  "cel_h11a": { img: "cel_h11a", path: "event", route: "cel", sensitive: true },
  "cel_h11b": { img: "cel_h11b", path: "event", route: "cel", sensitive: true },
  "cel_h09a": { img: "cel_h09a", path: "event", route: "cel", sensitive: true },
  "cel_h09b": { img: "cel_h09b", path: "event", route: "cel", sensitive: true },
  "cel_h10": { img: "cel_h10", path: "event", route: "cel", sensitive: true },

  "aki_e01": { img: "aki_e01", path: "event", route: "aki" },
  "aki_e01b": { img: "aki_e01b", path: "event", route: "aki" },
  "aki_e07a": { img: "aki_e07a", path: "event", route: "aki" },
  "aki_e07b": { img: "aki_e07b", path: "event", route: "aki" },
  ...
  "aki_e05b": { img: "aki_e05b", path: "event", route: "aki" },
  ...
  "stk_e01b": { img: "stk_e01b", path: "event", route: "aki" },
  "stk_e01c": { img: "stk_e01c", path: "event", route: "aki" },
  "stk_e01d": { img: "stk_e01d", path: "event", route: "aki" },
  ...
  "his_e01": { img: "his_e01", path: "event", route: "his" },
  "his_e01b": { img: "his_e01b", path: "event", route: "his" },
  "his_e02": { img: "his_e02", path: "event", route: "his" },
  "his_e02b": { img: "his_e02b", path: "event", route: "his" },
  "his_e02b2": { img: "his_e02b2", path: "event", route: "his" },
  ...
  "his_e07b": { img: "his_e07b", path: "event", route: "his" },
  ...
  "his_h01": { img: "his_h01", path: "event", route: "his", sensitive: true },
  ...
  "his_h04b": { img: "his_h04b", path: "event", route: "his", sensitive: true },
  ...
  "his_h06b": { img: "his_h06b", path: "event", route: "his", sensitive: true },
  ...
  "koha_e01b": { img: "koha_e01b", path: "event", route: "koha" },
  ...
  "koha_f01b": { img: "koha_f01b", path: "event", route: "koha" },
  ...
  "koha_h10b": { img: "koha_h10b", path: "event", route: "koha", sensitive: true },
  ...
  "koha_h06a": { img: "koha_h06a", path: "event", route: "koha", sensitive: true },
